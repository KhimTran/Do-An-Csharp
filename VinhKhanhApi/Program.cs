...
static async Task DamBaoCotPoiMoiAsync(AppDbContext db)
{
    var scripts = new[]
    {
        ...
        "IF COL_LENGTH('POIs','MoTaEnDeXuat') IS NULL ALTER TABLE POIs ADD MoTaEnDeXuat NVARCHAR(MAX) NULL;",
        "IF COL_LENGTH('POIs','MoTaZhDeXuat') IS NULL ALTER TABLE POIs ADD MoTaZhDeXuat NVARCHAR(MAX) NULL;",
        "IF COL_LENGTH('POIs','AudioFileViDeXuat') IS NULL ALTER TABLE POIs ADD AudioFileViDeXuat NVARCHAR(MAX) NULL;",
        "IF COL_LENGTH('POIs','AudioFileEnDeXuat') IS NULL ALTER TABLE POIs ADD AudioFileEnDeXuat NVARCHAR(MAX) NULL;",
