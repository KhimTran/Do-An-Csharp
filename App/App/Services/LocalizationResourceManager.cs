...
public sealed class LocalizationResourceManager : INotifyPropertyChanged
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _translations = new()
    {
        ["vi"] = new()
        {
            ...
            ["SettingsPage_Info"] = "Ứng dụng sẽ tự dùng endpoint đồng bộ mặc định để tránh gây rối cho khách du lịch.",
        ...
        ["en"] = new()
        {
            ...
            ["SettingsPage_Info"] = "The app uses the default sync endpoint to avoid confusing tourists.",
        ...
        ["zh"] = new()
        {
            ...
            ["SettingsPage_Info"] = "应用会默认使用同步端点，避免给游客造成困扰。",
