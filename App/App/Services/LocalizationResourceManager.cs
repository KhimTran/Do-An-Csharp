...
public sealed class LocalizationResourceManager : INotifyPropertyChanged
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _translations = new()
    {
        ["vi"] = new()
        {
            ...
            ["SettingsPage_AudioOfflineTitle"] = "Audio offline",
            ["SettingsPage_AudioOfflineDescription"] = "Tải sẵn MP3 để nghe khi mất mạng",
            ["SettingsPage_AudioOfflineStatusCachedFormat"] = "Đã có audio offline ({0})",
            ["SettingsPage_AudioOfflineStatusNotDownloaded"] = "Chưa tải",
            ["SettingsPage_AudioOfflineDownloading"] = "Đang tải...",
            ["SettingsPage_AudioOfflineDownloadButton"] = "Tải audio offline",
            ["SettingsPage_AudioOfflineClearButton"] = "Xóa audio offline",
            ["SettingsPage_AudioOfflineDownloadSummaryFormat"] = "Đã tải {0}/{1} file, bỏ qua {2}, lỗi {3}.",
            ["SettingsPage_AudioOfflineDownloadSummaryWithSizeFormat"] = "Đã tải {0}/{1} file, bỏ qua {2}, lỗi {3}. Dung lượng {4}.",
            ["SettingsPage_AudioOfflineCacheSizeFormat"] = "Dung lượng cache: {0}",
            ["SettingsPage_AudioOfflineDownloadError"] = "Tải audio offline bị lỗi",
            ["SettingsPage_AudioOfflineClearing"] = "Đang xóa cache...",
            ["SettingsPage_AudioOfflineCleared"] = "Đã xóa cache",
            ["SettingsPage_AudioOfflineClearedMessage"] = "Đã xóa audio offline.",
            ["SettingsPage_AudioOfflineClearError"] = "Xóa audio offline bị lỗi",
            ["SettingsPage_AudioOfflineNoMp3"] = "Không có file MP3 để tải.",
            ["SettingsPage_AudioOfflineDownloadProgressFormat"] = "Đang tải {0}/{1} file...",
            ["SettingsPage_AudioOfflineDownloadingPoiFormat"] = "Đang tải {0}/{1}: {2}",
        ...
        ["en"] = new()
        {
            ...
            ["SettingsPage_AudioOfflineTitle"] = "Offline audio",
            ["SettingsPage_AudioOfflineDescription"] = "Download MP3 files for listening without internet",
            ["SettingsPage_AudioOfflineStatusCachedFormat"] = "Offline audio ready ({0})",
            ["SettingsPage_AudioOfflineStatusNotDownloaded"] = "Not downloaded",
            ["SettingsPage_AudioOfflineDownloading"] = "Downloading...",
            ["SettingsPage_AudioOfflineDownloadButton"] = "Download offline audio",
            ["SettingsPage_AudioOfflineClearButton"] = "Clear offline audio",
            ["SettingsPage_AudioOfflineDownloadSummaryFormat"] = "Downloaded {0}/{1} files, skipped {2}, failed {3}.",
            ["SettingsPage_AudioOfflineDownloadSummaryWithSizeFormat"] = "Downloaded {0}/{1} files, skipped {2}, failed {3}. Size {4}.",
            ["SettingsPage_AudioOfflineCacheSizeFormat"] = "Cache size: {0}",
            ["SettingsPage_AudioOfflineDownloadError"] = "Offline audio download failed",
            ["SettingsPage_AudioOfflineClearing"] = "Clearing cache...",
            ["SettingsPage_AudioOfflineCleared"] = "Cache cleared",
            ["SettingsPage_AudioOfflineClearedMessage"] = "Offline audio has been cleared.",
            ["SettingsPage_AudioOfflineClearError"] = "Could not clear offline audio",
            ["SettingsPage_AudioOfflineNoMp3"] = "No MP3 files to download.",
            ["SettingsPage_AudioOfflineDownloadProgressFormat"] = "Downloading {0}/{1} files...",
            ["SettingsPage_AudioOfflineDownloadingPoiFormat"] = "Downloading {0}/{1}: {2}",
        ...
        ["zh"] = new()
        {
            ...
            ["SettingsPage_AudioOfflineTitle"] = "离线音频",
            ["SettingsPage_AudioOfflineDescription"] = "下载 MP3 以便无网络时收听",
            ["SettingsPage_AudioOfflineStatusCachedFormat"] = "离线音频已就绪（{0}）",
            ["SettingsPage_AudioOfflineStatusNotDownloaded"] = "尚未下载",
            ["SettingsPage_AudioOfflineDownloading"] = "正在下载...",
            ["SettingsPage_AudioOfflineDownloadButton"] = "下载离线音频",
            ["SettingsPage_AudioOfflineClearButton"] = "清除离线音频",
            ["SettingsPage_AudioOfflineDownloadSummaryFormat"] = "已下载 {0}/{1} 个文件，跳过 {2} 个，失败 {3} 个。",
            ["SettingsPage_AudioOfflineDownloadSummaryWithSizeFormat"] = "已下载 {0}/{1} 个文件，跳过 {2} 个，失败 {3} 个。大小 {4}。",
            ["SettingsPage_AudioOfflineCacheSizeFormat"] = "缓存大小：{0}",
            ["SettingsPage_AudioOfflineDownloadError"] = "离线音频下载失败",
            ["SettingsPage_AudioOfflineClearing"] = "正在清除缓存...",
            ["SettingsPage_AudioOfflineCleared"] = "缓存已清除",
            ["SettingsPage_AudioOfflineClearedMessage"] = "离线音频已清除。",
            ["SettingsPage_AudioOfflineClearError"] = "无法清除离线音频",
            ["SettingsPage_AudioOfflineNoMp3"] = "没有可下载的 MP3 文件。",
            ["SettingsPage_AudioOfflineDownloadProgressFormat"] = "正在下载 {0}/{1} 个文件...",
            ["SettingsPage_AudioOfflineDownloadingPoiFormat"] = "正在下载 {0}/{1}：{2}",
