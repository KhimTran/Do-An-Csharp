...
2 dòng quan trọng nhất bạn cần nhớ là:
- đổi toàn bộ `9` thành `10`
- ép nó luôn build bằng `net10.0-android`

Nếu muốn, tôi có thể làm tiếp cho bạn một bản `AGENTS.md` còn chặt hơn, chuyên riêng cho task “chuyể
